  ...
  return (
    <section className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-gray-500">Welcome back, Alex. Here's a summary of your account.</p>
      </div>
      <article className="rounded-[24px] border border-gray-200 bg-white p-6 shadow-sm">
        ...
        <div className="mt-5 grid gap-4 sm:grid-cols-3">
          {[
            { label: "Full Name", value: "Alex Curator" },
            { label: "Email Address", value: "alex.curator@email.com" },
      ...
      <article className="rounded-[24px] border border-gray-200 bg-white p-6 shadow-sm">
        ...
        <div className="mt-4 space-y-3">
          <div className="flex items-center gap-3 rounded-xl bg-teal-50 p-3">
            ...
            <div>
              <p className="text-[0.88rem] font-semibold text-gray-800">Order #ELM-992834 is out for delivery</p>
          ...
          <div className="flex items-center gap-3 rounded-xl bg-gray-50 p-3">
            ...
            <div>
              <p className="text-[0.88rem] font-semibold text-gray-800">Order #ELM-992834 was shipped</p>
              <p className="text-[0.76rem] text-gray-500">Oct 25, 01:15 PM</p>
            </div>
          </div>
        </div>
      </article>
    ...
    <section className="space-y-6">
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex gap-3">
          ...
          <Link to="/contact" className="rounded-xl bg-teal-600 px-4 py-2 text-[0.85rem] font-semibold text-white transition hover:bg-teal-700">
            Contact Seller
          </Link>
        </div>
      </div>
      <article className="rounded-[24px] border border-gray-200 bg-white p-6 shadow-sm">
        ...
        <div className="mt-6 grid gap-3 sm:grid-cols-4">
          {ORDER_PROGRESS_STEPS.map((step, index) => (
            <div key={step.label} className="relative">
              ...
              <p className={`mt-3 text-center text-[0.78rem] font-semibold ${step.done ? "text-gray-900" : "text-gray-400"}`}>{step.label}</p>
        ...
        <div className="mt-6 rounded-2xl bg-teal-50 p-4 text-[0.9rem] text-teal-800">
          ...
          <p className="mt-1 text-[0.82rem] text-teal-700">Your package is with the courier and may arrive by 8:00 PM.</p>
        </div>
      </article>
  ...
  return (
    <aside className="space-y-5">
      ...
      <article className="rounded-[20px] bg-teal-50 p-4">
        <p className="text-[0.9rem] font-semibold text-teal-800">Need help with this order?</p>
