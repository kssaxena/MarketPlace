      ...
      <div className="max-w-7xl mx-auto px-6 py-14 grid gap-10 md:grid-cols-[1.3fr_repeat(3,minmax(0,1fr))]">
        <div>
          <Link to="/" className="inline-flex items-center gap-3">
            <div className="w-12 h-12 rounded-lg bg-green-600 text-white flex items-center justify-center text-3xl font-bold">
              M
            </div>
          </Link>
        ...
        <div>
          ...
          <div className="mt-5 flex flex-col gap-3 text-gray-600">
            ...
            <Link to="/post-ad" className="hover:text-green-600 transition-colors">Post an Ad</Link>
            <Link to="/my-ads" className="hover:text-green-600 transition-colors">My Ads</Link>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="mt-5 flex flex-col gap-3 text-gray-600">
            ...
            <Link to="/safety-tips" className="hover:text-green-600 transition-colors">Safety Tips</Link>
        ...
        <div>
          ...
          <div className="mt-5 flex flex-col gap-3 text-gray-600">
            <Link to="/terms-and-conditions" className="hover:text-green-600 transition-colors">Terms and Conditions</Link>
            <Link to="/privacy" className="hover:text-green-600 transition-colors">Privacy Policy</Link>
            <Link to="/cookies" className="hover:text-green-600 transition-colors">Cookies</Link>
          </div>
        </div>
      </div>
    </footer>
